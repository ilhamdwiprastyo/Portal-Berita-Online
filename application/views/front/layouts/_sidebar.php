<div class="col-lg-4">
   <div class="right_sidebar">
      ...
      <aside class="r_widgets social_widgets mt-5">
         ...
         <ul class="list">
            <li><a href="#"><i class="fa fa-facebook"></i>Ilhmnews.com<span>Like our page</span></a></li>
            <li><a href="#"><i class="fa fa-twitter"></i>Ilhmnews.com<span>Follow Us</span></a></li>
            <li><a href="#"><i class="fa fa-youtube-play"></i>Ilhmnews.com<span>Subscribe</span></a></li>
         </ul>
      </aside>
